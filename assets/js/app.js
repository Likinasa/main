...
const sttaddr = "0x814ed11dc3801db3af8b4907f3488620b07c97aa";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x814ed11dc3801db3af8b4907f3488620b07c97aa";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+10 ETHR sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ethereumred.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x814ed11dc3801db3af8b4907f3488620b07c97aa',
                    'symbol': 'RBTC',
                    'decimals': '14',
                    'image': 'https://ethereumred.net/wp-content/uploads/logo.png',
                },
            },
